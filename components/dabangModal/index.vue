				...
				<view class="title-modal">
					...
					<view class="body-area">
						<u-row gutter="16" style="margin-top: 20rpx">
							...
							<u-col span="7" class="right-btn">
								<view class="col-top">
									<view class="btn-add-slice">
										<view class="slice" @click="add('jian')"
											>-</view
										>
										<input
											v-model="inpValue"
						...
						<u-row gutter="16" class="row-bottom">
							...
							>
                                <view class="shouhu-btn" v-if="index===2||index===3||index===6||index===7">守护者</view>
